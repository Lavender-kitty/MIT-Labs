...
l6_upper_spire.html
 ├─ l7_noble_court.html
 │   ├─ l8_assassination.html [WIP]
 │   └─ l8_diplomacy.html
 │       ├─ l9_militia_rise.html [WIP] -> (Expected: l10_victory_spire.html)
 │       └─ l_death_traitor.html [DEATH]
 └─ l7_vox_array.html
     ├─ l8_call_reinforcements.html [WIP] -> (Expected: l10_victory_spire.html)
